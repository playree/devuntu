...
Devuntu は、かんばん形式のボード/チケット管理を中心に、カレンダー連携・メール/Slack/Webプッシュ通知・MCP/AIエージェント連携などを備えた
...
- MCP サーバーとしての公開。AIエージェントから自分の権限でチケットを操作できる
- AIエージェントへのチケット委任。担当エージェントのCLIを自動起動して対応する
