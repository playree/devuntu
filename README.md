...
```sh
docker build --secret id=database_url,src=docker_build_env/database_url.env \
             --secret id=better_auth_url,src=docker_build_env/better_auth_url.env \
             --secret id=better_auth_secret,src=docker_build_env/better_auth_secret.env \
             -t devuntu .
```
