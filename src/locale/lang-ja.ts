...
export const ja: DefaultLocaleItems = {
  ...
  add_user: 'ユーザー追加',
  add_agent: 'エージェント追加',
  add_agent_approver_user: '承認ユーザー追加',
  admin: '管理者',
  agent: 'エージェント',
  agent_action_execute: '実行',
  agent_action_plan: 'プラン作成',
  ...
  agent_handle: '識別子',
  agent_host: 'ホスト',
  agent_last_polled: '最終ポーリング',
  agent_manage: 'エージェント管理',
  agent_approvals: 'エージェントの承認待ち',
  agent_approvals_total: '${count}件',
  agent_mode: 'エージェントモード',
  agent_mode_auto: '自動実行',
  agent_mode_none: '選択待ち',
  agent_mode_plan: 'プラン先行',
  agent_poll_interval: 'ポーリング間隔(分)',
  agent_profile: 'エージェント概要',
  agent_rule: 'ルール',
  agent_run_failed: '失敗',
  agent_run_history: '実行履歴',
  agent_run_running: '実行中',
  agent_run_skipped: '見送り',
  agent_run_succeeded: '成功',
  agent_runner: '自動運用',
  agent_runner_disabled: '停止中',
  agent_runner_none: '未設定',
  agent_runner_offline: 'オフライン',
  agent_runner_online: '稼働中',
  agent_runs_recent: 'エージェントの実行状況',
  ...
  ci_status_failure: 'CI失敗',
  ci_status_pending: 'CI実行中',
  ci_status_success: 'CI成功',
  ...
  command_def_add: 'コマンドを追加',
  command_def_conflict: '他の人がこのファイルを編集しました。最新の内容を読み込み直してからやり直してください。',
  command_def_delete: 'コマンドを削除',
  command_def_delete_confirm:
    'このコマンドの定義をファイルから削除します。有効化と許可グループの設定も消えます。よろしいですか?',
  command_def_dir: '定義ディレクトリ',
  command_def_edit: 'コマンドを編集',
  command_def_loaded: '読み込み ${loaded} ファイル / 除外 ${excluded} ファイル',
  command_def_not_editable:
    'このファイルは画面から編集できません。定義ファイルの target に editable: true を書いてください。',
  command_def_read_only:
    '定義ディレクトリが読み取り専用でマウントされています。書き込みできるようマウント設定を見直してください。',
  command_def_reload: '定義を再読み込み',
  command_def_template_label: 'コマンド名',
  command_def_yaml: 'コマンド定義(YAML)',
  command_def_yaml_invalid: 'YAML として読めません。',
  command_definition: 'コマンド定義',
  command_disabled: 'リモート実行機能は無効です。環境変数 COMMAND_EXEC_ENABLED を有効にしてください。',
  command_exec: 'リモート実行',
  command_executed_by: '実行者',
  command_exit_code: '終了コード',
  ...
  command_manage: 'リモート管理',
  command_no_def: '定義されているコマンドがありません。',
  command_no_input: '入力項目はありません。',
  command_no_target: 'アサインされているターゲットがありません。',
  command_reconnecting: '再接続中',
  command_run: '実行',
  command_run_args: '実行内容',
  command_run_cancel: '中断',
  command_run_detail: '実行の詳細',
  command_run_finished_at: '終了日時',
  command_run_history: '実行履歴',
  command_run_log: '実行ログ',
  command_run_queued_at: '受付日時',
  command_run_scope_all: '全員の実行',
  command_runs_recent: '最近のリモート実行',
  command_singleton: '多重実行の禁止',
  command_status_canceled: '中断',
  command_status_failed: '失敗',
  command_status_queued: '順番待ち',
  command_status_running: '実行中',
  command_status_succeeded: '成功',
  command_sys_args_mismatch: '選択された値が現在の定義と一致しないため実行できません。',
  command_sys_canceled: '中断されました。',
  command_sys_connection_lost: '実行中に接続が切れました。リモート側の状態を確認してください。',
  command_sys_def_missing: '実行しようとした定義が見つかりません。定義ファイルを確認してください。',
  command_sys_interrupted: '実行していたプロセスが応答しなくなったため、失敗として記録しました。',
  command_sys_log_partial: 'ログの一部を保存できなかったため、履歴が途中で欠けています。',
  command_sys_log_write_failed: 'ログを保存できなかったため中断しました。',
  command_sys_output_limit: '出力が異常に多いため中断しました。',
  command_sys_queued_canceled: '順番待ちの間に中断されました。',
  command_sys_ssh_error: '接続に失敗しました。ホスト鍵・鍵の権限・接続先の設定を確認してください。',
  command_sys_ssh_setup_failed: '接続先の秘密鍵または known_hosts を読み込めないため実行できません。',
  command_sys_timeout: 'タイムアウト(${sec}秒)により中断しました。',
  command_target: 'ターゲット',
  command_target_assign: 'アサイン',
  command_target_editable: '定義の編集を許可',
  ...
  command_target_orphan_description:
    '定義ファイルから消えたターゲットのアサインです。実行権限は与えられていません。同じIDが再利用される前に削除してください。',
  command_target_orphan_unknown: '定義ディレクトリを読み込めていないため、定義に存在しないターゲットを判定できません。',
  command_target_purge: 'アサインを削除',
  command_target_settings: 'ターゲット設定',
  command_timeout: 'タイムアウト',
  command_truncated: '出力が上限に達したため一部を保存していません。',
  comment: 'コメント',
  comment_type: '種別',
  comment_type_none: '通常',
  comment_type_plan: 'プラン',
  comment_type_report: '報告書',
  completed_at: '完了日時',
  ...
  mentioned: 'メンション',
  mention_in_ticket: '本文',
  my_mentions: '自分宛てのメンション',
  msg_maintenance_mode: 'ただいまメンテナンスを行っています。\n終了までしばらくお待ちください。',
  ...
  msg_command_group_is_member:
    'グループ経由のユーザーはメンバー扱いになります。オーナーはユーザー単位でアサインしてください。',
  msg_command_owner_can_edit: 'オーナーは、定義の編集が許可されたターゲットのコマンドを編集できます。',
  msg_command_queue_full: '順番待ちが上限に達しています。しばらく待ってから再度お試しください。',
  my_tickets: '自分の担当チケット',
  recent_activity: '最近更新されたチケット',
  name: '名前',
  name_locked: '名前をロック',
  next: '次へ',
  next_week: '翌週',
  ...
  notify_webpush_disable: 'この端末の通知を解除',
  notify_webpush_devices: '登録済みの端末',
  notify_webpush_this_device: 'この端末',
  ...
  priority_medium: '中',
  priority_urgent: '緊急',
  pr_state_closed: 'クローズ',
  pr_state_draft: 'ドラフト',
  pr_state_merged: 'マージ済み',
  pr_state_open: 'オープン',
  ...
  resend: '再送',
  results_none: '0件',
  results_range: '${total}件中 ${start}〜${end}件',
  role: 'ロール',
  rows_per_page: '表示件数',
  save: '保存',
  scope: 'スコープ',
  scope_email: 'メールアドレス',
  scope_mcp: 'チケットやボードへのアクセス',
  scope_offline_access: 'オフラインでの継続的なアクセス',
  ...
  theme_system: '自動',
  ticket: 'チケット',
  ticket_link_url: 'ブランチ / プルリクエスト / コミットのURL',
  ticket_links: '関連リンク',
  ticket_summary: 'ステータス集計',
  ticket_count: 'チケット数',
  time_range: '時間帯',
  timezone: 'タイムゾーン',
  title: '件名',
...
※シークレットは後から再確認できません。`,
  ...
  msg_confirm_rotate_token:
    '再発行すると、いまのトークンを使っている接続はすぐに利用できなくなります。よろしいですか？',
  ...
  msg_dynamic_oidc_clients:
    'MCP クライアントが接続時に自分で登録したものです。インストールごとに増えるため、利用者数より多くなります。無効化すると新しい認可を止められ、削除すると発行済みのトークンと同意も消えます。',
  ...
  msg_no_agent_approvals: '承認待ちのチケットはありません。',
  msg_no_agent_runs: '実行履歴はありません。',
  msg_no_approvable_agent: '承認者に設定されているエージェントがありません。',
  msg_no_boards: '参加しているボードがありません。',
  msg_no_command_runs: 'リモート実行の履歴はありません。',
...
`,
  ...
  notify_msg_ticket_completed_by_pr: 'プルリクエスト ${pr} の完了により、チケットを自動で完了しました',
