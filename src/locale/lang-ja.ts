...
※シークレットは後から再確認できません。`,
  ...
  msg_agent_approver_desc:
    '承認者だけがチケットのエージェントモードを変更できます。承認者が1人もいないエージェントは、誰もエージェントモードを変更できません。',
  ...
  msg_agent_runner_desc:
    '担当チケットを定期的に取りに来る常駐エージェントの設定です。稼働条件を満たすときだけ Claude が起動します。開始・終了はどちらか未指定なら終日稼働、開始が終了より後の場合は日跨ぎ(夜間のみ)として扱います。',
