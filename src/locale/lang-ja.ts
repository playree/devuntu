...
export const ja: DefaultLocaleItems = {
  ...
  close: '閉じる',
  codex_cli: 'Codex CLI',
  command_allowed_admin_only: '管理者のみ',
  command_allowed_groups: '実行を許可するグループ',
  ...
  command_def_id_changed: 'IDを変更すると、有効化と許可グループの設定は初期化されます。',
  ...
  command_enabled_description: '無効の間は一覧に表示されず、実行もできません。',
  command_exec: 'コマンド実行',
