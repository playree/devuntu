...
export const ja: DefaultLocaleItems = {
  ...
  list: '一覧',
  member: 'メンバー',
  mcp_add_command_claude: 'MCP登録コマンド (Claude Code)',
  mcp_add_command_codex: 'MCP登録コマンド (Codex CLI)',
  mcp_token: 'MCPトークン',
  mcp_token_env_command: '環境変数の設定 (Codex CLI)',
  mentioned: 'メンション',
  name: '名前',
  name_locked: '名前をロック',
  next: '次へ',
...
※シークレットは後から再確認できません。`,
  ...
  msg_agent_token_env:
    '登録コマンドにトークンは含まれません。トークンはランナーの config.json に設定し、環境変数 DEVUNTU_AGENT_TOKEN として CLI へ渡されます。作業ディレクトリごとに設定を分ける手順はセットアップ手順を参照してください。',
