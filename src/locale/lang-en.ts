...
export const en: LocaleItems = {
  ...
  close: 'Close',
  codex_cli: 'Codex CLI',
  command_allowed_admin_only: 'Administrators only',
  command_allowed_groups: 'Groups allowed to run',
  ...
  command_def_id_changed: 'Changing the ID resets the enablement and allowed groups.',
  ...
  command_enabled_description: 'While disabled, it is hidden from the list and cannot be run.',
