...
*The secret cannot be retrieved later.`,
  ...
  msg_confirm_revoke_token: 'Revoking stops any connection using this token immediately. Are you sure?',
  ...
  msg_revoked_target: 'Revoked ${target}.',
  msg_saved: 'Saved.',
