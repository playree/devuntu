...
export type DashboardWhereInput = {
  ...
  createdAt?: Prisma.DateTimeNullableFilter<"Dashboard"> | Date | string | null
  updatedAt?: Prisma.DateTimeNullableFilter<"Dashboard"> | Date | string | null
...
export type DashboardScalarWhereWithAggregatesInput = {
  ...
  createdAt?: Prisma.DateTimeNullableWithAggregatesFilter<"Dashboard"> | Date | string | null
  updatedAt?: Prisma.DateTimeNullableWithAggregatesFilter<"Dashboard"> | Date | string | null
}
...
export type DashboardCreateNestedOneWithoutUserInput = {
  ...
  connectOrCreate?: Prisma.DashboardCreateOrConnectWithoutUserInput
...
export type DashboardUpdateOneWithoutUserNestedInput = {
  create?: Prisma.XOR<Prisma.DashboardCreateWithoutUserInput, Prisma.DashboardUncheckedCreateWithoutUserInput>
  connectOrCreate?: Prisma.DashboardCreateOrConnectWithoutUserInput
  upsert?: Prisma.DashboardUpsertWithoutUserInput
  disconnect?: Prisma.DashboardWhereInput | boolean
  delete?: Prisma.DashboardWhereInput | boolean
  connect?: Prisma.DashboardWhereUniqueInput
  update?: Prisma.XOR<Prisma.XOR<Prisma.DashboardUpdateToOneWithWhereWithoutUserInput, Prisma.DashboardUpdateWithoutUserInput>, Prisma.DashboardUncheckedUpdateWithoutUserInput>
}
...
export interface DashboardDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const dashboardWithUserIdOnly = await prisma.dashboard.findMany({ select: { userId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Dashboards and only return the `userId`
   * const dashboardWithUserIdOnly = await prisma.dashboard.createManyAndReturn({
   *   select: { userId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Dashboards and only return the `userId`
   * const dashboardWithUserIdOnly = await prisma.dashboard.updateManyAndReturn({
   *   select: { userId: true },
   *   where: {
   *     // ... provide filter here
   *   },
